...
namespace openecontmd\client_api\modules;
 ...
 *   x={
 *       "tagGroups"=
 *           {{"name"="Exaample Grouping", "tags"={"client API", "Bank API"}}
 *       }
 *   }
 * )
 *
 ...
 * @OA\Tag(
 *     name="client",
 *     description="7. API for client and Notification Module"
 * )
 * @OA\Server(
...
http://api-docs.open.e-cont.tst/client/v1/sys
 ...
 * @OA\Tag(
 *     name="client API",
 *     description="client and notification operations"
 * )
 * @OA\Tag(
 *     name="Internal API",
