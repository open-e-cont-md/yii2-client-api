...
use openecontmd\client_api\models\BankInvoiceAPI;
 ...
 *              @OA\Examples(example="result_invoice", value={
 ...
 "controller": "invoice",
 "entry_point": "https://api.open.e-cont.md/client/v1/invoice/{action}"
 }
...
/** Set Invoice Number
 * @OA\Post(
 *     path="/client/v1/invoice/set-invoice-number",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
...
/** Set Issue Date
 * @OA\Post(
 *     path="/client/v1/invoice/set-issue-date",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
...
/** Set Due Date
 * @OA\Post(
 *     path="/client/v1/invoice/set-due-date",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact Name
 * @OA\Post(
 *     path="/client/v1/invoice/set-contact-name",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact E-Mail
 * @OA\Post(
 *     path="/client/v1/invoice/set-contact-email",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
...
/** Set Identifier
 * @OA\Post(
 *     path="/client/v1/invoice/set-identifier",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
...
/** Create Invoice
 * @OA\Post(
 *     path="/client/v1/invoice/create-invoice",
 *     method="post",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
 ...
 * @OA\Post(
 *     path="/client/v1/invoice/create-invoice-by-object",
 *     tags={"client"},
 ...
 * @OA\Post(
 *     path="/client/v1/invoice/create-party-by-object",
 *     tags={"client"},
...
/** Get Party By Id
 * @OA\Post(
 *     path="/client/v1/invoice/get-party-by-id",
 *     method="post",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
 ...
 * @OA\Post(
 *     path="/client/v1/invoice/get-invoice-by-number",
 *     method="post",
 *     tags={"client"},
 *     @OA\Response(
 *         response="200",
