...
namespace openecontmd\client_api\modules\client;

use Yii;
use yii\filters\VerbFilter;
//use yii\web\BadRequestHttpException;
use openecontmd\client_api\models\validation\ApiRequest;
use yii\web\HttpException;

class Module extends \yii\base\Module
{
	public $controllerNamespace = 'openecontmd\client_api\modules\client\controllers';
	public $gate = null;
...
//		$this->gate = Yii::$app->session->get('gate');
		...
		//$this->_check_token();
		//		$method = str_replace('client/v1/', '', $this->module->requestedRoute);
